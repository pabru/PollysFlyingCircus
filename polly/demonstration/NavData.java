...
import polly.demonstration.controller.ControlAlgorithm;
import polly.demonstration.controller.CtrlState;
import polly.demonstration.controller.Dimension;
import polly.demonstration.controller.FlyingState;
import polly.demonstration.controller.Mode;
import polly.demonstration.controller.NavDataTag;
import polly.demonstration.controller.Point;
import polly.demonstration.controller.VisionTag;
...
public class NavData {
	...
	//public static void main(String args[]) throws Exception {
		public static void initNavData()throws Exception{
		int seq = 1;
		...
		*/
		...
		send_at_cmd(at_cmd);
		*/
		//System.out.println("x vel:"+ getVx());
		atsocket.close();
		ndsocket.close();
